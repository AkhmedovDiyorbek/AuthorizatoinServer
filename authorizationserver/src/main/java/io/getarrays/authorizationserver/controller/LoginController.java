package io.getarrays.authorizationserver.controller;

import io.getarrays.authorizationserver.exception.ApiException;
import io.getarrays.authorizationserver.model.User;
import io.getarrays.authorizationserver.security.MfaAuthentication;
...
import static io.getarrays.authorizationserver.utils.RequestUtils.getMessage;
...
public class LoginController {
    ...
    public String logout(HttpServletRequest request, HttpServletResponse response, Model model, Exception exception){
    ...
    @PostMapping("/mfa")
    public void validateCode(@RequestParam("code") String code, HttpServletRequest request, HttpServletResponse response, @CurrentSecurityContext SecurityContext context) throws Exception{
